...
def get_readable_time(seconds: int) -> str:
    ...
    return ping_time
PM_START_TEXT = """
`𝙷𝚎𝚕𝚕𝚘` [👿](https://telegra.ph/file/9fbf1226ea18ef49432ba.jpg) `𝙼𝚢 𝚗𝚊𝚖𝚎 𝚒𝚜` *King Help Bot*
...
buttons = [
    [
     ...
     [
        InlineKeyboardButton(text="𝐀𝐛𝐨𝐮𝐭💝", callback_data="King"),
...
HELP_STRINGS = """
`𝙷𝚎𝚢!.. 𝙸'𝚖` 👿 *KING BOT* [👿](https://telegra.ph/file/a064bd8497a5f6f03b290.mp4)
